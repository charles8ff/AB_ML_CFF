...
Con el gráfico a continuación se ilustra lo que aportan cada variable a las 5 dimensiones que se han elegido.
```{r}
...
Posteriormente en el apartado de Métricas se decidirá cuál es el más apto para la resolución del problema.
...
Matriz de confusión del modelo con PCA:
```{r}
...
Este modelo **no** es mejora sustancial así que no nos lo quedamos
...
Yo pretendo minimizar los falsos positivos, es decir, los casos que me prediga una victoria y resulte ser una derrota-> Sensitividad?
